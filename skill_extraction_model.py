...
def main():
    ...
    loaded_model = BERTopic.load('./src/models/topic_modeling/model_dir')

    final_jobs = get_topics(jobs_with_skills,loaded_model)

    df = pd.DataFrame(final_jobs)
    df.to_json('final_data_with_topics.json')
